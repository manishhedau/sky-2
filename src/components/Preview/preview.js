    ...
    if (screen === 1) {
        return (
            <section className="preview-section">
                ...
                <div className="preview-container" style={{ background: userData.appearance.styles.background, 
                                                            fontFamily: userData.appearance.styles.font, 
                    ...
                    <div className="activity-links">
                        {userData.activityLinks.map(link => {
                            return <ActivityTile key={10000 + Math.ceil(Math.random() * 10000)} thumbnail="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fhdqwalls.com%2Fdownload%2Fconcert-show-crowd-peoples-music-party-5k-vo-2048x1152.jpg&f=1&nofb=1" title={link.title} />
                        })}
                    </div>
